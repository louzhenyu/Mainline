...
namespace EmitMapperDemo
{
    ...
    public class BasicUsageDemo
    {
        ...
        {
            public class InnerStruct //源中的类型是结构
            {
                public string InnerName { get; set; }
            }
            public struct InnerClass //源中的类型是类
            {
                public string InnerName { get; set; }
            }            
            ...
            public StatusEnum OrderNoStatus { get; set; } //源中的类型是string

            public InnerStruct PartStruct { get; set; } //源中的类型是结构

            public InnerClass PartClass { get; set; } //源中的类型是类

            public DestinationInnerClass[] GroupArray { get; set; } //源中的类名叫SourceInnerClass
