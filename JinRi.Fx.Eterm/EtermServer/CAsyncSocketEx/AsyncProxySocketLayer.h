...
public:
	...
	void SetProxy(int nProxyType, const TCHAR * pProxyHost, int ProxyPort); //May not be PROXYTYPE_NOPROXY
	void SetProxy(int nProxyType, const TCHAR * pProxyHost, int ProxyPort, const TCHAR * pProxyUser, const TCHAR * pProxyPass); //Only SOCKS5 and HTTP1.1 proxies
