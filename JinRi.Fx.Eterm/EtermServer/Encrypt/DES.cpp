...
//int main()
//{
//unsigned char *mingwen = (unsigned char*)"abcd";
//unsigned char *cip = new unsigned char[10];
//unsigned char *mcip = new unsigned char[10];
//for (int i=0;i<10;i++)
//   mcip[i] = cip[i] = '\0';
//DES mydes;
//bool se = mydes.CDesEnter(mingwen,cip,8,(unsigned char*)"abcdabcd",0);
//cout << cip;
//se = mydes.CDesEnter(cip,mcip,8,(unsigned char*)"abcdabcd",1);
//cout << mcip;
//return 0;
//}