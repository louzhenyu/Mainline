<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewLogSearch.aspx.cs" Inherits="LogView.NewLogSearch" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkForm() {
            ...
            var appid = document.getElementById("<%=txtAppid.ClientID%>").value;
            if (appid == "") {
                alert('对不起，请输入appid！');
