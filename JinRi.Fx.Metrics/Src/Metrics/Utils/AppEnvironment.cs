    ...
    public static class AppEnvironment
    {
        public static IEnumerable<EnvironmentEntry> Current
        {
            get
            {
                ...
                yield return new EnvironmentEntry("LocalTime", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture));
                yield return new EnvironmentEntry("AppId", System.Configuration.ConfigurationManager.AppSettings["AppId"] ?? "");
            }
        }
