...
namespace Metrics.Json
{
    public class JsonTimer : JsonMetric
    {
        ...
        private static IEnumerable<JsonProperty> ToJsonProperties(HistogramData histogram)
        {
            ...
            yield return new JsonProperty("Sum", histogram.Sum);
        }
        ...
        public TimerValueSource ToValueSource()
        {
            ...
            //RANEN.TONG        无UnitCount
            var rateValue = new MeterValue(this.Count, this.Count, this.Rate.MeanRate, this.Rate.OneMinuteRate, this.Rate.FiveMinuteRate, this.Rate.FifteenMinuteRate, rateUnit);
            var histogramValue = new HistogramValue(this.Count,
                ...
                this.Histogram.Percentile99, this.Histogram.Percentile999, this.Histogram.SampleSize, this.Count * System.Convert.ToInt64(this.Histogram.Mean));
