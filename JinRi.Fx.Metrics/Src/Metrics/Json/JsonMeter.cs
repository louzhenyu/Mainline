    ...
    public class JsonMeter : JsonMetric
    {
        ...
        public static JsonMeter FromMeter(MeterValueSource meter)
        {
            return new JsonMeter
            {
                ...
                UnitCount = meter.Value.UnitCount,
        ...
        public IEnumerable<JsonProperty> ToJsonProperties()
        {
            ...
            yield return new JsonProperty("UnitCount", this.UnitCount);
        ...
        private static IEnumerable<JsonProperty> ToJsonProperties(SetItem item)
        {
            ...
            yield return new JsonProperty("UnitCount", item.UnitCount);
        ...
        public MeterValueSource ToValueSource()
        {
            ...
            var items = this.Items.Select(i =>
                new MeterValue.SetItem(i.Item, i.Percent,
                    new MeterValue(i.Count, i.UnitCount, i.MeanRate, i.OneMinuteRate, i.FiveMinuteRate, i.FifteenMinuteRate, rateUnit)))
                .ToArray();

            var meterValue = new MeterValue(this.Count, this.UnitCount, this.MeanRate, this.OneMinuteRate, this.FiveMinuteRate, this.FifteenMinuteRate, rateUnit, items);
